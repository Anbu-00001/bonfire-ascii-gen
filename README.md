...
## Key Features
- **Absolute Structural Floor**: The animator pre-renders a "Perfect Base" of the sword hilt. During the animation loop, it intercepts any "weak" characters (spaces, dots, or dashes) in the sword zone and forces them back to their original high-density form. This ensures the sword is 100% unbreakable.
- **Constrained Sword Mapping**: The hilt and blade use a dynamic "Heavy Palette" (`+=*#@W`). This allows the metal to realistically react to firelight pulses without ever thinning out.
- **Cinematic 24-Frame Loop**: Optimized 24-frame pre-calculation engine for a silky-smooth, cinematic rotation at 12 FPS.
